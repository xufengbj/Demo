...
- (UIAlertController *)alertController {
    if (!_alertController) {
        ...
        _alertController = [UIAlertController alertControllerWithTitle:@"已为“友邻优课”关闭无线局域网" message:@"您可以在“设置”中为此应用打开无线局域网。" preferredStyle:UIAlertControllerStyleAlert];
        
        [_alertController addAction:[UIAlertAction actionWithTitle:@"好" style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
            [self hideNetworkRestrictedAlert];
        }]];
